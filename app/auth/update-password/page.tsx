...
export default function UpdatePasswordPage() {
    ...
    // Support multiple Supabase recovery link formats
    ...
    // ✅ Hydrate a session from ANY Supabase password recovery link format
    useEffect(() => {
        let cancelled = false;
        ...
        (async () => {
            ...
            try {
                ...
                // (B) OTP recovery link: ?token_hash=...&type=recovery
                // Some projects include type=recovery, some may omit it
                ...
                // (C) Implicit recovery link: #access_token=...&refresh_token=...&type=recovery
